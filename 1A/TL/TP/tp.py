...
def pointfloat_state_0():
    ...
    if ch == ".":
        intv += pointfloat_state_1()

    elif digit(ch):
        intv += pointfloat_state_2()
...
def pointfloat_state_1():
    ...
    if digit(ch):
        is_ok, out_ch = pointfloat_state_3()
        return (is_ok, ch + out_ch)
...
if __name__ == "__main__":
    ...
    try:
        ...
        if ok:
            ...
            print(
                "value:", val
            )  # décommenter ici pour afficher la valeur (question 4 et +)
        else:
            print("Rejected!")
            print(
                "value so far:", int_value
            )  # décommenter ici pour afficher la valeur en cas de rejet
    except Error as e:
        print("Error:", e)
